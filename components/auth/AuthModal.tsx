...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  const handleGoogleSignIn = async () => {
    ...
    // Simulating OAuth / Supabase Auth flow with instant login experience
    setTimeout(async () => {
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2 pt-1">
              <button
                ...
                className="w-full py-3 px-4 rounded-2xl bg-white hover:bg-slate-100 text-slate-900 font-bold text-xs flex items-center justify-center gap-2.5 transition-all shadow-md active:scale-98"
              >
              ...
              <button
                ...
                className="w-full py-3 px-4 rounded-2xl bg-black hover:bg-slate-950 text-white font-bold text-xs flex items-center justify-center gap-2.5 transition-all border border-slate-700 active:scale-98"
              >
