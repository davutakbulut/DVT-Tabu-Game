...
export const RuleSettingsModal: React.FC<RuleSettingsModalProps> = ({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Oyun Kurallarını Özelleştir">
      <div className="flex flex-col gap-5 text-slate-200 max-h-[72vh] overflow-y-auto pr-1">
        ...
        {/* Action Buttons */}
        <div className="pt-3 border-t border-slate-800 flex gap-3 sticky bottom-0 bg-slate-950/95 py-2">
