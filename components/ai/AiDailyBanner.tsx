...
import { Sparkles, RefreshCw, Zap, Trophy, Check, Clock, RotateCcw, X, PlusCircle, CheckCircle2 } from 'lucide-react';
    ...
    <div className="w-full rounded-3xl bg-gradient-to-r from-indigo-950/80 via-slate-900 to-purple-950/80 border border-indigo-500/30 p-5 shadow-xl relative overflow-hidden backdrop-blur-md">
      ...
      <div className="flex items-center justify-between pb-3 mb-3 border-b border-indigo-500/20">
        <div className="flex items-center gap-2">
          ...
          <div>
            <span className="text-xs font-bold uppercase tracking-wider text-indigo-300 block leading-tight">
              Günün AI Oyun Bülteni
            </span>
            <span className="text-[10px] text-slate-400">Yapay Zeka Taktik ve Kural Önerileri</span>
          </div>
        </div>
        <button
